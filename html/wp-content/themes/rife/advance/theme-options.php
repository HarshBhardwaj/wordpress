	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				'id'          => 'logo_shield_hide',
				'type'        => 'slider',
				'title'       => esc_html__( 'Sticky header', 'rife' ). ' : ' .esc_html__( 'How many percent logo should fold up', 'rife' ),
				'description' => esc_html__( 'Works only with the sticky header.', 'rife' ) .' '. esc_html__( 'How many percent(%) of the logo should be hidden by folding up. The percentage is counted from the header height, not the shield height, so you may need to use values above 100%.', 'rife' ),
				'min'         => 0,
				'max'         => 250,
				'step'        => 1,
				'unit'        => '%',
			...
			array(
				...
				'type'        => 'slider',
				'title'       => esc_html__( 'How many percent logo should fold up', 'rife' ). ' - ' .esc_html__( 'on mobile devices', 'rife' ),
				'description' => esc_html__( 'It works only on mobile devices(1024px wide or less).', 'rife' ) .' '. esc_html__( 'How many percent(%) of the logo should be hidden by folding up. The percentage is counted from the header height, not the shield height, so you may need to use values above 100%.', 'rife' ),
				'min'         => 0,
				'step'        => 1,
				'max'         => 250,
				'unit'        => '%',
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'options'  => array(
					'x'  => esc_html__( 'X', 'rife' ),
					'x2'  => esc_html__( 'X 2', 'rife' ),
					'x3'  => esc_html__( 'X 3', 'rife' ),
					'slider'  => esc_html__( 'Slider', 'rife' ),
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'type'    => 'select',
				'title'   => esc_html__( 'Choose the proportions of the bricks', 'rife' ) . ' : ' . esc_html__( 'Featured Image ', 'rife' ),
				'options' => array(
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				...
				'title'    => esc_html__( 'Default filter', 'rife' ),
				'for'      => 'post',
				'default'  => '__all',
			...
			array(
				...
				'type'     => 'radio',
				'title'    => esc_html__( 'Display "All" filter', 'rife' ),
				'options'  => $on_off,
				'default'  => 'on',
				'required'    => array(
	...
	$apollo13framework_a13->set_sections( array(
		...
		'fields'     => array(
			...
			array(
				'id'      => 'shop_add_to_cart',
				'type'    => 'radio',
				'title'   => esc_html__( 'Where to display the "Add to Cart" button', 'rife' ),
				'options' => array(
					'over' => esc_html__( 'Over the image', 'rife' ),
					'in-text'   => esc_html__( 'In the text', 'rife' ),
				),
				'default' => 'over',
				'required' => array( 'shop_products_variant', '=', 'under' ),
			),
			...
			array(
				...
				'type'        => 'radio',
				'title'       => esc_html__( 'Bricks columns', 'rife' ). ' - ' .esc_html__( 'on mobiles', 'rife' ),
				'description' => esc_html__( 'It will be used on small devices(less than 600 pixels wide).', 'rife' ),
				'options' => array(
					'1' => '1',
					'2' => '2',
				),
