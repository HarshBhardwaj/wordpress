...
function apollo13framework_print_proofing_filters($id = null){
	...
	<ul class="category-filter single-album-proofing-filter clearfix">
		...
		<li data-filter="1"><a><?php esc_html_e( 'Selected', 'rife' ); ?><i class="count"></i></a></li>
		<li data-filter="0"><a><?php esc_html_e( 'Not selected', 'rife' ); ?><i class="count"></i></a></li>
		<li data-filter="2"><a><?php esc_html_e( 'Commented', 'rife' ); ?><i class="count"></i></a></li>
	</ul>
